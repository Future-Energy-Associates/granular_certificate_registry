...
def downgrade() -> None:
    ...
    op.add_column('granularcertificateaction', sa.Column('certificate_status', postgresql.ENUM('ACTIVE', 'CANCELLED', 'CLAIMED', 'EXPIRED', 'WITHDRAWN', 'LOCKED', 'RESERVED', name='certificatestatus'), autoincrement=False, nullable=True))
    ...
    op.add_column('granularcertificateaction', sa.Column('certificate_bundle_percentage', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('granularcertificateaction', sa.Column('sparse_filter_list', postgresql.ARRAY(postgresql.JSON(astext_type=sa.Text())), autoincrement=False, nullable=True))
    ...
    op.add_column('granularcertificateaction', sa.Column('certificate_quantity', sa.INTEGER(), autoincrement=False, nullable=True))
