...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("account_id", sa.Integer(), nullable=False),
        sa.Column("bundle_id_range_start", sa.Integer(), nullable=False),
        sa.Column("bundle_id_range_end", sa.Integer(), nullable=False),
        sa.Column("bundle_quantity", sa.Integer(), nullable=False),
